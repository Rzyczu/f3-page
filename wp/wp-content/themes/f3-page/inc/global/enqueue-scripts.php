...
function enqueue_theme_scripts() {
    ...
    if (is_front_page()) {
        wp_enqueue_script('opinions-script', get_template_directory_uri() . '/js/opinions.js', array(), '1.0.0', true);
        wp_enqueue_script('news-script', get_template_directory_uri() . '/js/news.js', array(), '1.0.0', true);
        wp_enqueue_script('swiper-js', 'https://cdn.jsdelivr.net/npm/swiper@11/swiper-bundle.min.js', array(), null, true);
    }

    // Skrypty dla strony "About Us"
    if (is_page('about-us')) {
        wp_enqueue_script('circular-slider-script', get_template_directory_uri() . '/js/circular-slider.js', array(), '1.0.0', true);
        wp_enqueue_script('board-script', get_template_directory_uri() . '/js/board.js', array(), '1.0.0', true);
        wp_enqueue_script('banner-brotherhood-script', get_template_directory_uri() . '/js/banner-brotherhood.js', array(), '1.0.0', true);
    }

    // Skrypty dla strony "Join Us"
    if (is_page('join-us')) {
        wp_enqueue_script('scout-path-script', get_template_directory_uri() . '/js/scout-path.js', array(), '1.0.0', true);
    }
